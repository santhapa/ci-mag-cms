...
<form class="form-horizontal validate" action="<?php echo site_url('admin/page/add'); ?>" method="post">
    <div class="box-body">
        <div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <input id="title" type="text" name="title" class="form-control required" required value="<?php echo set_value('title'); ?>" placeholder="Page    Title" required/>
            ...
            <div class="col-xs-12 col-sm-3">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <input id="featuredImage" type="hidden" name="featuredImage" class="form-control" value="<?php echo set_value('featuredImage'); ?>"/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <input type="checkbox" id="showComments" name="showComments" value="1" 
                                    <?php echo set_checkbox('showComments', 1); ?>>&emsp;
...
<script type="text/javascript">
    ...
    $(function(){
        var featuredImage = "<?php echo set_value('featuredImage')?:''; ?>";
        if(featuredImage) preview(featuredImage);
