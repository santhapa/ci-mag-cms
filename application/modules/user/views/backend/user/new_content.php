<div class="box-body">
    <form class="form-horizontal validate" method="POST" action="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input class="form-control required" type="text" id="firstname" name="firstname" value="<?php echo set_value('firstname'); ?>" placeholder="First Name" required>
                <?php echo form_error('firstname'); ?>    
            </div>
            <label class="col-sm-2 control-label" for="lastname">Last Name</label>
            <div class="col-sm-3">
                <input class="form-control required" type="text" id="lastname" name="lastname" value="<?php echo set_value('lastname'); ?>" placeholder="Last Name" required>
